<template>
  <transition name="modal-fade">
    <div v-if="image" class="preview-overlay" @wheel.prevent="handleWheel" @mousedown="startDrag" @mousemove="onDrag" @mouseup="endDrag" @mouseleave="endDrag" @touchstart="startTouch" @touchmove="onTouch" @touchend="endTouch">
      <!-- 顶部工具栏 -->
      ...
      <div class="preview-content" ref="containerRef">
        <img
          ...
          :alt="image.title"
          class="preview-image"
          :style="{ transform: `translate(${posX}px, ${posY}px) scale(${scale})`, cursor: isDragging ? 'grabbing' : 'grab' }"
          draggable="false"
