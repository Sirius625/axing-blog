...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "knowledge-app pt-16" },
});
/** @type {__VLS_StyleScopedClasses['knowledge-app']} */ ;
/** @type {__VLS_StyleScopedClasses['pt-16']} */ ;
const __VLS_0 = KnowledgeHeader;
// @ts-ignore
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    totalItems: (__VLS_ctx.totalItems),
    categoryCount: (__VLS_ctx.categories.length),
}));
const __VLS_2 = __VLS_1({
    totalItems: (__VLS_ctx.totalItems),
    categoryCount: (__VLS_ctx.categories.length),
}, ...__VLS_functionalComponentArgsRest(__VLS_1));
const __VLS_5 = KnowledgeFilter;
// @ts-ignore
const __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5({
    modelValue: (__VLS_ctx.searchQuery),
    activeCategory: (__VLS_ctx.activeCategory),
...
for (const [item] of __VLS_vFor((__VLS_ctx.filteredItems))) {
    ...
    var __VLS_14;
    // @ts-ignore
    [totalItems, categories, categories, searchQuery, activeCategory, filteredItems, openDetail,];
}
...
var __VLS_21;
// @ts-ignore
[filteredItems, selectedItem, closeModal,];
