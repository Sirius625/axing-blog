  ...
  <div class="blog-app">
    ...
    <div class="blog-content">
      ...
      <div v-else class="empty-state">
        ...
        <p>{{ searchQuery || activeCategory !== 'all' ? '尝试更换关键词或分类' : '点击上方按钮写第一篇文章吧' }}</p>
      </div>
        ...
        <div class="modal-container modal-detail">
          ...
          <div class="modal-body detail-body">
            <div class="detail-meta">
              ...
              <span><i class="fa-regular fa-calendar"></i> {{ formatDate(detailArticle.created_at) }}</span>
            ...
            <div class="detail-actions">
              ...
              <button v-if="authStore.isLoggedIn && (currentUsername === detailArticle.author)" class="action-btn delete-btn" @click="handleDelete(detailArticle.id)">
          ...
          <div class="modal-body editor-body">
            <div class="editor-form">
              ...
              <div class="form-group">
                <label>摘要</label>
                <textarea v-model="editorForm.summary" placeholder="文章摘要（可选）" class="form-input form-textarea" rows="2"></textarea>
              </div>
              <div class="form-group">
                <label>标签（逗号分隔）</label>
...
const handleDelete = async (id: number) => {
  try {
    ...
    if (result && (result as any).success) {
      ...
      ElMessage.error((result as any)?.message || '删除失败，请稍后重试')
    }
  } catch (err: any) {
